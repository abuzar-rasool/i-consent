...
type ParticipantViewInputs = z.infer<typeof formSchema>;
    ...
    <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-6 max-w-4xl mx-auto">
      ...
      <div>
        ...
        <p>
          ...
          , first and last name. This information will be visible to the
          researchers conducting the study and will be used internally by the
          iConsent platform to track the consent status.
        </p>
      </div>
      <Form {...form}>
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-2">
          ...
          >
            {mutation.isLoading
              ? 'Submitting...'
              : 'Continue To Consent Form Signing'}
          </Button>
        </form>
      </Form>
